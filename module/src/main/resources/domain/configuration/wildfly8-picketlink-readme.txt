In the <wildfly-home>/domain/configuration/domain.xml add the following:

1) Under domain/extensions add:

 <extension module="org.wildfly.extension.picketlink"/>
 
2) Under domain/profiles/profile add (example configuration only!):
